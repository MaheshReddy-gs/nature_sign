...
const MasterPlanSection = () => {
  return (
    <section id="master-plan" className="relative bg-[#FFFBF5] overflow-hidden min-h-screen lg:h-screen
           flex items-start lg:items-center justify-center
           pt-[135px] sm:pt-[145px] lg:pt-0 pb-4 lg:pb-10 font-['Montserrat']">
      ...
      <div className="absolute top-0 left-0 w-full bg-white h-[110px] z-10 flex items-center justify-center">
        <FloatUpText className="text-[#a1461a] text-center text-xs font-bold tracking-[0.2em] uppercase mb-5">
          MASTER PLAN
        </FloatUpText>
      </div>
